...
class ResCompany(models.Model):
    ...
    def _enrich(self):
        ...
        # Erase image_1920 even if something is in it. Indeed as partner_ares is probably installed as a
        # core app (mail -> iap -> partner_ares auto install chain) it is unlikely that people already
